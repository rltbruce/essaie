...
class Module_sep extends REST_Controller {
    ...
    public function index_get() 
    {
        ...
        if ($menu=='getmoduleBycontrat')
         {
            $tmp = $this->Module_sepManager->findmoduleBycontrat($id_contrat_partenaire_relai);
            if ($tmp) 
            {
        ...
        elseif ($menu=='getmodulevalideBycontrat')
         {
            $tmp = $this->Module_sepManager->findvalideBycontrat($id_contrat_partenaire_relai);
            if ($tmp) 
            {
                foreach ($tmp as $key => $value) 
                {
        ...
        elseif ($menu=='getmoduleinvalideBycontrat')
         {
            $tmp = $this->Module_sepManager->findinvalideBycontrat($id_contrat_partenaire_relai);
            if ($tmp) 
            {
                foreach ($tmp as $key => $value) 
                {
