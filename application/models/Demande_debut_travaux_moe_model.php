...
class Demande_debut_travaux_moe_model extends CI_Model {
    protected $table = 'demande_debut_travaux_moe';

    public function add($demande_debut_travaux_moe) {
        $this->db->set($this->_set($demande_debut_travaux_moe))                
                            ->insert($this->table);
    ...
    public function update($id, $demande_debut_travaux_moe) {
        $this->db->set($this->_set($demande_debut_travaux_moe))
    ...
    public function _set($demande_debut_travaux_moe) {
        return array(
            ...
            'date'          =>      $demande_debut_travaux_moe['date'],
            'id_contrat_bureau_etude'    =>  $demande_debut_travaux_moe['id_contrat_bureau_etude'],
            'validation'    =>  $demande_debut_travaux_moe['validation']                       
        );
    }
