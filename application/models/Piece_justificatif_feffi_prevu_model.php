...
class Piece_justificatif_feffi_prevu_model extends CI_Model {
    protected $table = 'Piece_justificatif_feffi_prevu';

    public function add($Piece_justificatif_feffi_prevu) {
        $this->db->set($this->_set($Piece_justificatif_feffi_prevu))
                            ->insert($this->table);
    ...
    public function update($id, $Piece_justificatif_feffi_prevu) {
        $this->db->set($this->_set($Piece_justificatif_feffi_prevu))
                            ->where('id', (int) $id)
                            ->update($this->table);
        if($this->db->affected_rows() === 1)
    ...
    public function _set($Piece_justificatif_feffi_prevu) {
        return array(
            'code'       =>      $Piece_justificatif_feffi_prevu['code'],
            'intitule'   =>      $Piece_justificatif_feffi_prevu['intitule'],
            'id_tranche'   =>      $Piece_justificatif_feffi_prevu['id_tranche']                       
        );
    }
